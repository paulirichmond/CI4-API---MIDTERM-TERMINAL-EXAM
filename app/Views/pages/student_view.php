...
<div class="card mb-16" id="studentForm" style="<?= isset($student) ? '' : 'display:none;' ?>">
    ...
    <div class="card-body">
        <form action="<?= isset($student) ? site_url('student/update/' . $student['id']) : site_url('student/store') ?>" method="post">
            <?= csrf_field() ?>
        ...
        <table class="data-table" id="studentTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= site_url('student/show/' . $s['id']) ?>"
                    ...
                    <td>
                        <div style="display:flex;gap:4px;">
                            <a href="<?= site_url('student/edit/' . $s['id']) ?>" class="btn btn-secondary btn-xs">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="<?= site_url('student/delete/' . $s['id']) ?>" method="post" class="d-inline"
