...
class Filters extends BaseFilters
{
    ...
    public array $globals = [
        'before' => [
            ...
            'isGranted'  => ['except' => ['/', 'register', 'login', 'logout', 'blocked', 'unauthorized', 'dashboard', 'dashboard-v2', 'dashboard-v3', 'student/*', 'students', 'students/*', 'student', 'profile', 'profile/*', 'admin/*', 'api/v1/*']],
            // 'honeypot',
            // 'csrf',
            // 'invalidchars',
        ],
